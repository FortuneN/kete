...
├── coverage-badge.json                           # Coverage badge fallback (CI publishes the live value with the docs site)
...
**Current Coverage**: see the badge in the README — the Develop workflow generates `coverage-badge.json` and each release publishes it at `https://fortunen.github.io/kete/coverage-badge.json`
