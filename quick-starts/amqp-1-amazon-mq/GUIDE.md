# Amazon MQ for ActiveMQ (AMQP 1.0) Quick Start

This quick start demonstrates forwarding Keycloak events to **Amazon MQ for ActiveMQ** using the AMQP 1.0 protocol.
...
Wait for the broker to become available (this can take several minutes):
...
Find the AMQP endpoint (port 5671). The hostname will look like:
`b-1234abcd-5678-efgh-9012-ijklmnopqrst-1.mq.us-east-1.amazonaws.com`
...
4. Check the ActiveMQ Web Console at `https://<broker-endpoint>:8162`
