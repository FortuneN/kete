...
@Component(name = "properties", scope = Component.SINGLETON)
public class PropertiesSerializer extends Serializer {

	private static final ObjectMapper MAPPER = new ObjectMapper(new JavaPropsFactory());
