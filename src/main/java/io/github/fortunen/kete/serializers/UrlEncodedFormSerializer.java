...
@Component(name = "url-encoded-form", scope = Component.TRANSIENT)
public class UrlEncodedFormSerializer extends Serializer {
	...
	public byte[] serialize(Event event) {
		...
		return encodeForm(pairs).getBytes(StandardCharsets.UTF_8);
	}
	...
	private String encodeForm(Map<String, String> pairs) {
