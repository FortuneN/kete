# Google Cloud Memorystore for Redis (Pub/Sub) Quick Start

This quick start demonstrates forwarding Keycloak events to **Google Cloud Memorystore for Redis** using Redis Pub/Sub.
...
4. Connect to your Memorystore instance and subscribe:
