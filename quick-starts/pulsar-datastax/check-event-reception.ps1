# Check if event was received by DataStax Luna Streaming (Pulsar-compatible)
...
$result = docker exec pulsar-datastax-pulsar-1 bin/pulsar-admin topics stats "persistent://$tenant/$namespace/$topic" 2>&1
