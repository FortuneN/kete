...
class acceptAdminEventTests {

	@Test
	void shouldGracefullyIgnoreNullAdminEvent() {
		...
		assertThatCode(() -> factory.accept(null, false)).doesNotThrowAnyException();
	}
	...
	void shouldGracefullyHandleUninitializedState() {
		...
		assertThatCode(() -> factory.accept(event, false)).doesNotThrowAnyException();
	}
